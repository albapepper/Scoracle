...
export const getThemeColors = (colorScheme = 'light') => theme[colorScheme]?.colors || theme.light.colors;
export const getBoxShadow = (colorScheme = 'light') => theme.boxShadow[colorScheme] || theme.boxShadow.light;
